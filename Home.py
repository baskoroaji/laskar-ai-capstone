...
st.write("# Kenal Jiwa App")

st.markdown(
    """
    Kenal Jiwa merupakan aplikasi screening kesehatan mental berbasis AI yang dapat membantu
    pendeteksian dini penyakit mental. Aplikasi ini juga merupakan sebuah capstone project
    dari program Laskar AI 2025.
    **👈 Gunakan Aplikasi pada menu disamping**
    ### Another Resources
